...
func TestAccNetboxVirtualizationVMPrimaryIPMinimal(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckNetboxVirtualizationVMPrimaryIPConfig(nameSuffix, false, false, ipnum),
...
func TestAccNetboxVirtualizationVMPrimaryIPFull(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckNetboxVirtualizationVMPrimaryIPConfig(nameSuffix, true, true, ipnum),
				Check: resource.ComposeTestCheckFunc(
					util.TestAccResourceExists(resourceNameNetboxVirtualizationVMPrimaryIP),
				),
			},
...
func TestAccNetboxVirtualizationVMPrimaryIPMinimalFullMinimal(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccCheckNetboxVirtualizationVMPrimaryIPConfig(nameSuffix, false, true, ipnum),
				Check: resource.ComposeTestCheckFunc(
					util.TestAccResourceExists(resourceNameNetboxVirtualizationVMPrimaryIP),
				),
			},
...
func testAccCheckNetboxVirtualizationVMPrimaryIPConfig(nameSuffix string, resourceFull, extraResources bool, ipnum int64) string {
	template := `
