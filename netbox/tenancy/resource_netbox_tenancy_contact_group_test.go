...
const resourceNameNetboxTenancyContactGroup = "netbox_tenancy_contact_group.test"
...
func TestAccNetboxTenancyContactGroupMinimal(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckNetboxTenancyContactGroupConfig(nameSuffix, false, false, 0),
				Check: resource.ComposeTestCheckFunc(
					util.TestAccResourceExists(resourceNameNetboxTenancyContactGroup),
				),
			},
			{
...
func TestAccNetboxTenancyContactGroupFull(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckNetboxTenancyContactGroupConfig(nameSuffix, true, true, asn),
				Check: resource.ComposeTestCheckFunc(
					util.TestAccResourceExists(resourceNameNetboxTenancyContactGroup),
				),
			},
...
func TestAccNetboxTenancyContactGroupMinimalFullMinimal(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckNetboxTenancyContactGroupConfig(nameSuffix, false, false, asn),
				Check: resource.ComposeTestCheckFunc(
					util.TestAccResourceExists(resourceNameNetboxTenancyContactGroup),
				),
			},
			...
			{
				Config: testAccCheckNetboxTenancyContactGroupConfig(nameSuffix, false, true, asn),
				Check: resource.ComposeTestCheckFunc(
					util.TestAccResourceExists(resourceNameNetboxTenancyContactGroup),
				),
			},
...
func testAccCheckNetboxTenancyContactGroupConfig(nameSuffix string, resourceFull, extraResources bool, asn int64) string {
	template := `
