...
func TestAccNetboxTenancyContactMinimal(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckNetboxTenancyContactConfig(nameSuffix, false, false),
				Check: resource.ComposeTestCheckFunc(
					util.TestAccResourceExists(resourceNameNetboxTenancyContact),
				),
			},
			{
...
func TestAccNetboxTenancyContactFull(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckNetboxTenancyContactConfig(nameSuffix, true, true),
				Check: resource.ComposeTestCheckFunc(
					util.TestAccResourceExists(resourceNameNetboxTenancyContact),
				),
			},
...
func TestAccNetboxTenancyContactMinimalFullMinimal(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccCheckNetboxTenancyContactConfig(nameSuffix, false, true),
				Check: resource.ComposeTestCheckFunc(
					util.TestAccResourceExists(resourceNameNetboxTenancyContact),
				),
			},
...
func testAccCheckNetboxTenancyContactConfig(nameSuffix string, resourceFull, extraResources bool) string {
	template := `
