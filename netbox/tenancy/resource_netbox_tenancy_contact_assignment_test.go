...
const resourceNameNetboxTenancyContactAssignment = "netbox_tenancy_contact_assignment.test"
...
func TestAccNetboxTenancyContactAssignmentFull(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckNetboxTenancyContactAssignmentConfig(nameSuffix),
				Check: resource.ComposeTestCheckFunc(
					util.TestAccResourceExists(resourceNameNetboxTenancyContactAssignment),
				),
			},
			{
...
func testAccCheckNetboxTenancyContactAssignmentConfig(nameSuffix string) string {
	template := `
