...
func TestAccNetboxIpamServiceMinimal(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckNetboxIpamServiceConfig(nameSuffix, false, false),
...
func TestAccNetboxIpamServiceFull(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckNetboxIpamServiceConfig(nameSuffix, true, true),
				Check: resource.ComposeTestCheckFunc(
					util.TestAccResourceExists(resourceNameIpamService),
				),
			},
...
func TestAccNetboxIpamServiceMinimalFullMinimal(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccCheckNetboxIpamServiceConfig(nameSuffix, false, true),
				Check: resource.ComposeTestCheckFunc(
					util.TestAccResourceExists(resourceNameIpamService),
				),
			},
...
func testAccCheckNetboxIpamServiceConfig(nameSuffix string, resourceFull, extraResources bool) string {
	const template = `
