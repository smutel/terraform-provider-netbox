...
func TestAccNetboxIpamPrefixMinimal(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckNetboxIpamPrefixConfig(nameSuffix, false, false),
...
func TestAccNetboxIpamPrefixFull(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckNetboxIpamPrefixConfig(nameSuffix, true, true),
				Check: resource.ComposeTestCheckFunc(
					util.TestAccResourceExists(resourceNameIpamPrefix),
				),
			},
...
func TestAccNetboxIpamPrefixMinimalFullMinimal(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccCheckNetboxIpamPrefixConfig(nameSuffix, false, true),
				Check: resource.ComposeTestCheckFunc(
					util.TestAccResourceExists(resourceNameIpamPrefix),
				),
			},
...
func testAccCheckNetboxIpamPrefixConfig(nameSuffix string, resourceFull, extraResources bool) string {
	const template = `
