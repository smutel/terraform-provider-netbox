...
func TestAccNetboxIpamVlanMinimal(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckNetboxIpamVlanConfig(nameSuffix, false, false),
...
func TestAccNetboxIpamVlanFull(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckNetboxIpamVlanConfig(nameSuffix, true, true),
				Check: resource.ComposeTestCheckFunc(
					util.TestAccResourceExists(resourceNameIpamVlan),
				),
			},
...
func TestAccNetboxIpamVlanMinimalFullMinimal(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccCheckNetboxIpamVlanConfig(nameSuffix, false, true),
				Check: resource.ComposeTestCheckFunc(
					util.TestAccResourceExists(resourceNameIpamVlan),
				),
			},
...
func testAccCheckNetboxIpamVlanConfig(nameSuffix string, resourceFull, extraResources bool) string {
	const template = `
