...
func TestAccNetboxIpamIPRangeMinimal(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckNetboxIpamIPRangeConfig(nameSuffix, false, false),
...
func TestAccNetboxIpamIPRangeFull(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckNetboxIpamIPRangeConfig(nameSuffix, true, true),
				Check: resource.ComposeTestCheckFunc(
					util.TestAccResourceExists(resourceNameIpamIPRange),
				),
			},
...
func TestAccNetboxIpamIPRangeMinimalFullMinimal(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccCheckNetboxIpamIPRangeConfig(nameSuffix, false, true),
				Check: resource.ComposeTestCheckFunc(
					util.TestAccResourceExists(resourceNameIpamIPRange),
				),
			},
...
func testAccCheckNetboxIpamIPRangeConfig(nameSuffix string, resourceFull, extraResources bool) string {
	const template = `
