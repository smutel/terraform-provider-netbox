...
This project does not use [netbox-community/go-netbox](https://github.com/netbox-community/go-netbox) but the same library generated by myself located here [smutel/go-netbox](https://github.com/smutel/go-netbox). By the past this project was not maintained anymore so I decided to create my own project.
...
```shell
export NETBOX_PROVIDER_VERSION=8.0.0
